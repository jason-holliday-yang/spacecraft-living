...
static const BackpackEntryDef kBackpackEntries[BACKPACK_ENTRY_COUNT] = {
    ...
    {BACKPACK_ENTRY_RESOURCE, RESOURCE_ENERGY_CORE, LT("Energy Core", "能源核心"), LT("High-value power source needed for major system restoration and peaceful rescue tech.", "高价值能源源件，是恢复关键系统与和平救援装置的核心材料。"), Color{255, 207, 96, 255}, Color{185, 126, 45, 255}},
    ...
    {BACKPACK_ENTRY_RESOURCE, RESOURCE_BOSS_SCALE, LT("Boss Scale", "首领鳞片"), LT("Rare trophy from the guardian. Proof of combat success in the final area.", "守卫掉落的稀有战利品，是最终区域战斗胜利的证明。"), Color{222, 126, 102, 255}, Color{139, 70, 58, 255}},
