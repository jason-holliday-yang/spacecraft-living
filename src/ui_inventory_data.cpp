...
static const BackpackEntryDef kBackpackEntries[BACKPACK_ENTRY_COUNT] = {
    ...
    {BACKPACK_ENTRY_RESOURCE, RESOURCE_ENERGY_CORE, LT("Energy Core", "能源核心"), LT("High-value power source needed for major system restoration and peaceful rescue tech.", "高价值能源部件，是修复关键系统与和平救援装置的核心材料。"), Color{255, 207, 96, 255}, Color{185, 126, 45, 255}},
