...
void UI_DrawHud(const Player *player, const TaskSystem *tasks, const HudMessage *message, const AssetBundle *assets, int screenWidth, int screenHeight) {
    ...
    UIRuntime_DrawText(assets, "Survival", Vector2{vitalsPanel.x + 16.0f * scale, vitalsPanel.y + 12.0f * scale}, 24.0f * scale, WHITE);
    ...
    UIRuntime_DrawText(assets, "Mission Status", Vector2{statusPanel.x + 18.0f * scale, statusPanel.y + 14.0f * scale}, 25.0f * scale, WHITE);
    ...
    snprintf(reserveBuffer, sizeof(reserveBuffer), "Active Effects: %d", Player_GetActiveStatusCount(player));
    ...
    if (showLoxiGuidance) {
        ...
        UIRuntime_DrawText(assets, "Loxi Guidance", Vector2{objectivePanel.x + 18.0f * scale, objectivePanel.y + 14.0f * scale}, 25.0f * scale, WHITE);
    ...
    UIRuntime_DrawText(assets, "Quick Access", Vector2{shortcutsPanel.x + 12.0f * scale, shortcutsPanel.y - 22.0f * scale}, 15.0f * scale, Color{182, 199, 214, 255});
    UIRuntime_DrawHudShortcut(assets, UI_GetHudShortcutRect(screenWidth, screenHeight, 0), "Map", "Scout", "M", 0, Color{110, 201, 255, 255}, Color{62, 118, 192, 255});
    UIRuntime_DrawHudShortcut(assets, UI_GetHudShortcutRect(screenWidth, screenHeight, 1), "Bag", "Supplies", "B", 1, Color{232, 180, 113, 255}, Color{127, 84, 44, 255});
