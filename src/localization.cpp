...
static const NamedTranslation kLiteralTranslations[] = {
    ...
    {"Sync fragments at Loxi and review its rewritten ending picture for rescue, stabilization, and settlement.", "带着碎片去洛希处同步，并查看它重新整理出的救援、稳定与定居终局图景。"},
    {"Sync fragments at Loxi and let it align the west crew trail with the south facility record.", "带着碎片去洛希处同步，让它把西线船员轨迹与南方设施记录对齐。"},
    {"Collect 3 Relic Fragments and bring them to Loxi so it can compare force, stabilization, and settlement with full system context.", "收集 3 枚遗迹碎片并带回洛希，让它在完整系统背景下比较强行、稳定与定居三种路线。"},
    {"Collect 3 Relic Fragments and bring them to Loxi so it can align the west and south evidence into one timeline.", "收集 3 枚遗迹碎片并带回洛希，让它把西线与南线证据拼成同一条时间线。"},
    {"Heroic route chosen. Reach the Signal Tower and launch the rescue beacon.", "已选择强行救援路线。前往信号塔并发射求救信标。"},
    {"Heroic route chosen. Defeat the guardian in the isolated arena, then return to the Signal Tower.", "已选择强行救援路线。先在隔离战场击败守卫，再返回信号塔。"},
    {"Heroic route chosen. Open the airlock and commit to the guardian arena.", "已选择强行救援路线。打开气闸，正式进入守卫战场。"},
    ...
    {"Fragments ready. Loxi can now rewrite the ending picture around one failing maintenance lattice.", "碎片已齐。洛希现在可以围绕一套失效中的维护格网重构终局图景。"},
    {"Fragments ready. Loxi can now align the west crew trail with the south facility record.", "碎片已齐。洛希现在可以把西线船员轨迹与南方设施记录对齐。"},
    {"Late-route analysis is unlocked. Gather 3 fragments so Loxi can finish its rewritten ending picture.", "终局分析已经解锁。请收集 3 枚碎片，让洛希完成它重写后的终局图景。"},
    {"Shared evidence is unlocked. Gather 3 fragments so Loxi can join the west and south record.", "共通证据已解锁。请收集 3 枚碎片，让洛希把西线与南线记录拼在一起。"},
    {"Collect 3 Relic Fragments in north ruins.", "在北方遗迹中收集 3 枚遗迹碎片。"},
    {"Ruins prep now supports Loxi's rewritten ending picture. Finish the fragment set and return.", "遗迹准备工作如今已能支撑洛希重写后的终局图景。收齐碎片后返回。"},
    {"Collect fragments in ruins and return to base.", "在遗迹中收集碎片后返回基地。"},
    {"Gather fragments, then sync with Loxi.", "先收集碎片，再与洛希同步。"},
    ...
    {"Heroic route chosen. The ring is fully lit. Open the airlock when you are ready for the isolated guardian arena.", "已选择强行救援路线。石碑环已完全点亮。准备好后打开气闸，进入隔离守卫战场。"},
    {"Heroic route chosen. Your monolith prep carries into the arena. Open the airlock when you are ready.", "已选择强行救援路线。你的石碑准备会直接带入战场。准备好后打开气闸。"},
    {"Heroic route chosen. Open the airlock to begin the isolated guardian fight.", "已选择强行救援路线。打开气闸，开始隔离守卫战。"},
    ...
    {"Heroic route selected. The guardian is isolated, and the fully lit ring is weakening it.", "已选择强行救援路线。守卫已被隔离，而完整石碑环正在削弱它。"},
    {"Heroic route selected. The guardian is isolated inside the arena. Finish the fight, then return to the tower.", "已选择强行救援路线。守卫已被隔离在战场中。结束这场战斗后，再回到塔楼。"},
    {"Heroic route selected. The guardian is isolated, and the ring is already weakening it. Open the airlock when ready.", "已选择强行救援路线。守卫已被隔离，石碑环也已经在削弱它。准备好后打开气闸。"},
    {"Heroic route selected. Open the airlock to enter the guardian arena.", "已选择强行救援路线。打开气闸，进入守卫战场。"},
    ...
    {"Fragments can now let Loxi compare rescue, repair, and settlement with full system context.", "这些碎片如今能让洛希在完整系统背景下比较救援、修复与定居。"},
    {"Fragments can now let Loxi align west crew traces with south facility handovers.", "这些碎片如今能让洛希把西线船员痕迹与南方设施交接记录对齐。"},
    {"Return fragments to Loxi terminal.", "把碎片带回洛希终端。"},
    {"Finish fragment runs so Loxi can complete its maintenance-lattice ending picture.", "完成碎片搜集，让洛希补完那套维护格网终局图景。"},
    {"Finish fragment runs so Loxi can lock the west/south timeline together.", "完成碎片搜集，让洛希把西线 / 南线时间线彻底锁定。"},
    ...
    {"Heroic route chosen. The ring is ready. Open the airlock when you are ready for the guardian arena.", "已选择强行救援路线。石碑环已经准备完毕。准备好后打开气闸，进入守卫战场。"},
    {"Heroic route chosen. Open the airlock to start the guardian fight.", "已选择强行救援路线。打开气闸，开始守卫战。"},
    ...
    {"Guardian Arena is clear. Return to the ship and finish at the Signal Tower.", "守卫战场已经清空。返回飞船，然后去信号塔完成最后一步。"},
    {"Guardian Arena: the monolith ring is already softening this fight. Keep oxygen margin for the last phase.", "守卫战场：石碑环已经在削弱这场战斗。为最后阶段保留足够氧气余量。"},
    {"Guardian Arena: no route tricks remain. Stabilize oxygen and win the fight cleanly.", "守卫战场：已经没有路线技巧可取巧了。稳住氧气，把这场战斗干净利落地打完。"},
    {"Unknown Stage", "未知阶段"},
    {"Day", "白天"},
    {"Dusk", "黄昏"},
    {"Night", "夜晚"},
    ...
    {"The heroic route is locked in, but the tower is waiting on the isolated guardian breach. Open the ship airlock, clear the arena, then return here.", "强行救援路线已经锁定，但塔楼正在等待隔离守卫突破完成。打开飞船气闸，清空战场，然后再回到这里。"},
    {"The heroic route is locked in. The arena breach is ready at the ship airlock, and your lit monoliths will still help once the guardian engages.", "强行救援路线已经锁定。飞船气闸处的战场突破已经就绪，而你点亮的石碑会在守卫开战后继续提供帮助。"},
    {"The heroic route is locked in. The ship airlock now leads into the guardian arena. Clear that fight before trying to launch the tower.", "强行救援路线已经锁定。飞船气闸现在会通向守卫战场。先打完那场战斗，再尝试启动塔楼。"},
    {"Loxi online. Heroic route confirmed. The airlock is now cycling toward an isolated guardian arena, and the completed monolith ring will help once you enter.", "洛希已上线。强行救援路线已确认。气闸现在会切换到隔离守卫战场，而完整石碑环会在你进入后提供帮助。"},
    {"Loxi online. Heroic route confirmed. The airlock now leads into an isolated guardian arena. Any monolith prep you already completed will still help there.", "洛希已上线。强行救援路线已确认。气闸现在会通向一个隔离的守卫战场。你此前完成的任何石碑准备，都会在那场战斗中生效。"},
    {"Airlock cycling into isolated breach mode. The outer door will not reopen into the world route yet; it will throw you straight into the guardian arena. Win there, then come back for the tower.", "气闸正在切换到隔离突破模式。外门暂时不会重新连回常规地图，而是会直接把你送进守卫战场。赢下那边的战斗，再回来完成塔楼。"},
    {"The guardian collapses and the breach spits you back to the ship-side airlock. The Signal Tower is now the final step.", "守卫已经崩溃，突破通道把你重新甩回了飞船侧的气闸。信号塔现在就是最后一步。"},
    {"Base summary: guardian breach complete. The Signal Tower is now exposed.", "基地简报：守卫突破已经完成。信号塔现在已经完全暴露出来。"},
    ...
    {"Base summary: guardian breach complete. Finish the heroic route at the Signal Tower.", "基地简报：守卫突破已经完成。前往信号塔完成强行救援路线。"},
    {"Base summary: heroic route locked. Open the airlock when you are ready to enter the guardian arena.", "基地简报：强行救援路线已经锁定。准备好后打开气闸，进入守卫战场。"},
