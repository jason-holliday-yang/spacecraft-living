...
static const NamedTranslation kLiteralTranslations[] = {
    ...
    {"Finish the fragment runs so Loxi can complete its maintenance-lattice ending picture.", "完成碎片搜集，让洛希补完那套维护格网终局图景。"},
    ...
    {"Crouching in the forest makes you harder to detect.", "在森林中蹲下会让你更难被发现。"},
    {"Use crouch in the forest to stay hidden.", "在森林中使用蹲伏来潜行。"},
