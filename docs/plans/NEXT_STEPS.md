...
- 英雄路线已固定为 `飞船 / 洛希归档复核 -> 路线确认 -> 北线西北遗迹守卫战 -> 返回 Signal Tower`
- 当前 `14` 份已接线日志已经有终端详情文本；当前最优先缺口为 `X1-X3` 的表现层深化、基地归档一致性修正、真相拼装表达补强与终局页收口
...
- 固定 `飞船 / 洛希归档复核 -> 路线确认 -> 路线执行` 的终局顺序
- 继续清除所有旧的“直接塔顶选结局”残留文案
- 保持英雄路线的 `北线推进 -> 西北遗迹守卫战 -> 返回塔楼` 口径在所有文档、objective 和文本里一致
...
- 固定 `飞船 / 洛希归档复核 -> 路线确认 -> 路线执行` 的终局顺序，并清除所有旧的“直接塔顶选结局”残留文案
